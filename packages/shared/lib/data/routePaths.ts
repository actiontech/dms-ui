...
export const ROUTE_PATHS = {
  BASE: {
    ...
    USER_BIND: {
      index: {
        path: '/user/bind',
        query: 'oauth2_token&error&user_exist&dms_token&refresh_token&target'
      }
    },
    HOME: '/',
  ...
  SQLE: {
    ...
    SQL_EXEC_WORKFLOW: {
      ...
      analyze: {
        prefix: '/sqle/project/:projectID/exec-workflow',
        path: ':taskId/:sqlNum/:instanceName/analyze'
      },
      sql_files_overview: {
        prefix: '/sqle/project/:projectID/exec-workflow',
    ...
    SQL_MANAGEMENT_CONF: {
      ...
      analyze: {
        prefix: '/sqle/project/:projectID/sql-management-conf',
        path: ':instanceAuditPlanId/analyze/:id/:instanceName'
      }
    },
    SQL_MANAGEMENT: {
      index: {
