...
export const BasicCascaderStyleWrapper = styled(Cascader)`
  &.ant-select.basic-cascader-wrapper {
    .ant-select-clear {
      width: 14px;
      height: 14px;
      font-size: 14px;
  ...
  &.basic-cascader-wrapper.ant-select:not(.ant-select-customize-input) {
    .ant-select-selector {
      border-radius: 4px;
      border: ${({ theme }) =>
