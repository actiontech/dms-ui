...
import ActiveSessionTrend from '../ActiveSessionTrend';
...
describe('ActiveSessionTrend', () => {
  ...
  it('should render component correctly when task is supported', async () => {
    const { baseElement } = superRender(
      <ActiveSessionTrend {...defaultProps} />
    );
    ...
    expect(getSqlPerformanceInsightsSpy).toHaveBeenCalledWith({
      ...
      metric_name: 'active_session_trend',
  ...
  it('should not render when task is not supported', async () => {
    ...
    superRender(<ActiveSessionTrend {...defaultProps} />);
  ...
  it('should handle polling interval', async () => {
    ...
    superRender(<ActiveSessionTrend {...propsWithPolling} />);
