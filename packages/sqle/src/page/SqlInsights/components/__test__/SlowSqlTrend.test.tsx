...
describe('SlowSqlTrend', () => {
  ...
  it('should not render when task is not supported', async () => {
    ...
    superRender(<SlowSqlTrend {...defaultProps} />);
  ...
  it('should handle polling interval', async () => {
    ...
    superRender(<SlowSqlTrend {...propsWithPolling} />);
