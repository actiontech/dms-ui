...
describe('sqle/Order/List', () => {
  ...
  let RequestExportOrderList: jest.SpyInstance;
  ...
  beforeEach(() => {
    ...
    RequestExportOrderList = order.exportWorkflow();
  ...
  it('render click export btn', async () => {
    ...
    expect(baseElement).toMatchSnapshot();
    await act(async () => jest.advanceTimersByTime(3000));
    expect(RequestExportOrderList).toHaveBeenCalled();
    expect(RequestExportOrderList).toHaveBeenCalledWith(
      {
