...
import { paramsSerializer, SystemRole } from '@actiontech/dms-kit';
...
describe('provision/DatabaseAccount/List', () => {
  ...
  beforeEach(() => {
    ...
    authListMemberGroupSpy = jest
      .spyOn(MemberGroupService, 'ListMemberGroupTips')
      .mockImplementation(() =>
  ...
  it('render actions when no permission', async () => {
    mockUseCurrentUser({
      isAdmin: false,
      userRoles: {
    ...
    expect(screen.queryByText('批量修改密码')).not.toBeInTheDocument();
  });
