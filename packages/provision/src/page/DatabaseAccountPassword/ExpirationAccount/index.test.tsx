...
describe('provision/DatabaseAccountPassword/ExpirationAccount-1', () => {
  ...
  test('render accout list when user do not have permission', async () => {
    ...
    expect(screen.queryAllByText('修改密码')).toHaveLength(0);
    expect(screen.queryAllByText('续用当前密码')).toHaveLength(0);
  });
});
