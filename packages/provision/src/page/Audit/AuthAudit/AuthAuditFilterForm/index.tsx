...
const AuthAuditFilterForm: FC = () => {
  ...
  return (
    <TableFilterForm
      ...
      filterFormButtonLayout={filterFormButtonLayoutFactory(12, 0, 0)}
    >
      <Col {...FilterFormColLayout}>
        <Form.Item
          name="filter_by_permission_user"
          label={t('provisionAudit.authAudit.columns.permissionUser')}
        >
          <Input allowClear />
        </Form.Item>
      </Col>
      <Col {...FilterFormColLayout}>
        <Form.Item
          ...
          label={t('provisionAudit.authAudit.columns.purpose')}
        >
          <Input allowClear />
        </Form.Item>
      </Col>
      <Col {...FilterFormColLayout}>
        <Form.Item
          ...
          label={t('provisionAudit.authAudit.columns.template')}
        >
          <Input allowClear />
        </Form.Item>
      </Col>
