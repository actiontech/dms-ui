...
export const IconAuditStatusIsUpdated = () => {
  return (
...
export const IconAuditStatusIsCreated = () => {
  return (
    <CommonIconStyleWrapper className="custom-icon">
      <svg
        width="16"
...
export const IconAuditStatusIsDeleted = () => {
  return (
    <CommonIconStyleWrapper className="custom-icon">
      <svg
        width="16"
...
export const IconIsEnabled: React.FC<CustomIconProps> = () => {
  return (
    <CommonIconStyleWrapper>
      <svg
        width="16"
...
export const IconIsDisabled: React.FC<CustomIconProps> = () => {
  return (
    <CommonIconStyleWrapper>
      <svg
        width="16"
