...
export const SideMenuStyleWrapper = styled('div')`
  &.diagnosis-layout-side {
    position: sticky;
    top: 0;
    width: ${({ theme }) => theme.diagnosisTheme.sideMenu.width}px;
    max-height: 100vh;
    overflow: hidden;
    display: flex;
    padding: 0 ${({ theme }) => theme.diagnosisTheme.sideMenu.padding}px;
    flex-direction: column;
    align-items: flex-start;
    justify-content: space-between;
    background-color: ${({ theme }) =>
      theme.diagnosisTheme.sideMenu.backgroundColor};
    box-shadow: ${({ theme }) => theme.diagnosisTheme.sideMenu.boxShadow};
    border-right: ${({ theme }) => theme.diagnosisTheme.sideMenu.border};
    z-index: 10;
    ...
    .diagnosis-layout-side-end {
      ...
      .global-system-icon-wrapper {
        ...
        border-radius: 100px;
        background-color: ${({ theme }) =>
          theme.diagnosisTheme.sideMenu.globalSystem.backgroundColor};
      }
    }
  }
`;
...
export const PopoverInnerStyleWrapper = styled('div')`
  ...
  border-radius: 8px;
  border: ${({ theme }) => theme.diagnosisTheme.sideMenu.userNavigate.border};
  box-shadow: ${({ theme }) =>
    theme.diagnosisTheme.sideMenu.userNavigate.boxShadow};
  background-color: ${({ theme }) =>
    theme.diagnosisTheme.sideMenu.userNavigate.backgroundColor};

  .header {
    padding: 12px 14px;
    align-items: center;
    border-bottom: ${({ theme }) =>
      theme.diagnosisTheme.sideMenu.userNavigate.title.border};
    color: ${({ theme }) =>
      theme.diagnosisTheme.sideMenu.userNavigate.title.color};
    font-size: 13px;
    font-style: normal;
    font-weight: 500;
    line-height: 20px;
  ...
  .content {
    ...
    &-item {
      ...
      line-height: 20px;
      color: ${({ theme }) =>
        theme.diagnosisTheme.sideMenu.userNavigate.content.color};

      &:hover {
        background-color: ${({ theme }) =>
          theme.diagnosisTheme.sideMenu.userNavigate.content
  ...
  .footer {
    ...
    &-text {
      ...
      line-height: 20px;
      color: ${({ theme }) =>
        theme.diagnosisTheme.sideMenu.userNavigate.footer.text.color};
    }
    ...
    &-icon {
      ...
      border-radius: 100px;
      border: ${({ theme }) =>
        theme.diagnosisTheme.sideMenu.userNavigate.footer.iconWrapper.border};
      background-color: ${({ theme }) =>
        theme.diagnosisTheme.sideMenu.userNavigate.footer.iconWrapper
          .backgroundColor};
      ...
      &-wrapper {
        ...
        cursor: pointer;
        color: ${({ theme }) =>
          theme.diagnosisTheme.sideMenu.userNavigate.footer.iconWrapper.color};
        border-radius: 100px;
